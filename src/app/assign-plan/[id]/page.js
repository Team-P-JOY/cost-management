...
function DetailContent() {
  ...
  const breadcrumb = [
    ...
    { name: "กำหนดรายวิชา", link: "/assign-plan" },
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <select
                              ...
                              disabled
                              className={`${className.select} bg-gray-100 dark:bg-gray-700 cursor-not-allowed opacity-75`}>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              readOnly
                              className={`${className.input} bg-gray-100 dark:bg-gray-700 cursor-not-allowed opacity-75`}
                            />
                          </div>
